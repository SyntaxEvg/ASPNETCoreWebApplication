...
namespace EmployeeService
{
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IValidator<AuthenticationRequest>, AuthenticationRequestValidator>();//Крутая штука берите на вооружение 
            builder.Services.AddScoped<IValidator<AccountDTOREG>, AccountDTOREGValidator>();//Крутая штука берите на вооружение 
